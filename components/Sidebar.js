    ...
    return (
        <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
            <div className="flex items-center justify-center w-14 h-14 hoverAnimation p-0">
                <Image src="https://cdn-icons.flaticon.com/png/512/3128/premium/3128310.png?token=exp=1642061266~hmac=e00cfe7bde14698df3bd454d89c6f7c9" width={30} height={30} alt=""/>
            </div>
            <div className="space-y-2.5 mt-4 mb-2.5 xl:mb-1">
